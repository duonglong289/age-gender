...
def train(args):
    ...
    age_gender_model.init_model(num_age_classes=16)     #(num_age_classes=None)
    ...
    age_gender_model.train(num_epochs=num_epochs-15, learning_rate=init_lr/10, freeze=False)
